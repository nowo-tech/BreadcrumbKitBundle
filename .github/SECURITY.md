...
We take the security of **BreadcrumbKitBundle** seriously. If you believe you have found a security vulnerability, please report it privately:
...
For technical details and the release security checklist, see [docs/SECURITY.md](../docs/SECURITY.md).
