...
| US-06 | **As an** admin integrator, **I want** an optional web dashboard to manage collections and breadcrumb items **so that** I can configure trails without raw SQL (see [`CONFIGURATION.md`](CONFIGURATION.md) § Dashboard). |
...
**Goal:** Symfony bundle: configurable breadcrumb trails (route matching, i18n, optional links, collection-level presentation).
