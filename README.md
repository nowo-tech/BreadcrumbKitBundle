...
Latest release: **[v2.0.10](https://github.com/nowo-tech/BreadcrumbKitBundle/releases/tag/v2.0.10)** (2026-07-30). Requires **PHP 8.2+** and **Symfony 7+**. Tables: `dashboard_breadcrumb_*` (see [UPGRADING.md](docs/UPGRADING.md) from v1.2.x).
